...
class ReviewCrudController extends CrudController
{
    ...
    {
        CRUD::column('user.name')->label('Кто оставил');
        CRUD::column('targetUser.name')->label('Кому оставили');
        CRUD::column('result')->label('Комментарий');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('result')->label('Комментарий');
