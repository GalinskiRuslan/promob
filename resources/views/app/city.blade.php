...
@section('content')
    <main class="main"><h1 class="visually-hidden">Главная</h1>
                ...
                <div class="container">
                    <div class="hero__bg"
                        ...
                        <h2 class="hero__bg-title">Платформа <span class="primary-color">№1</span> <span
                                class="hero__bg-title_span">для <span class="primary-color">медиа-профессионалов</span> в Казахстане</span>
                        </h2>
                        ...
                        <form class="hero__form" method="GET"
                              action="@isset($category) @if ($category) {{ route('search_category', ['city' => $corrent_city->alias, 'category' => $category]) }} @else {{ route('search', $corrent_city->alias) }} @endif @endisset">
                                            ...
                                            <div class="filter__content">
                                                ...
                                                <div class="slider-price">
                                                    <div class="slider-price-display">
                                                        <span class="slider-price-display-min">500 ₽</span>
                                                        <span class="slider-price-display-max">25 000 000 ₽</span>
                                                    </div>
                                ...
                                @if($user->role == 'executor')
                                    <article class="card">
                                        <div class="card__header">
                                            <div class="card__profile">
                                                <picture class="card__profile-avatar">
                                                    ...
                                                    <img loading="lazy"
                                                         ...
                                                         class="image" width="142"
                                                         height="142" alt="Картинка"></picture>
                                                <div class="card__profile-info"><a class="btn menu__job-link"
                                                                                   href="{{ route('user_view', $user->id) }}">
                                                        <h3
                                                            class="card__profile-name">
                                                    ...
                                                    <div class="card__profile-location"><span
                                                            class="icon icon-color icon-lg"><svg><use
                                            ...
                                            <div class="card__info"><a href="{{ route('comments.index', $user->id) }}" class="btn card__reviews"><span
                                                        class="icon"><svg><use
                                                                    ...
                                                                    <div class="swiper-slide">
                                                                        <picture class="swiper-slide-picture">
                                                                                ...
                                                                                <img loading="lazy" src="{{asset($galleryItem) }}"
                                                                                     class="image"
                                                                                     width="348" height="224" alt="Картинка">
                                                                            </picture>
                                                                    </div>
                                                                @endif
                                        ...
                                        <div class="card__price"><span class="icon icon-color icon-xl"><svg><use
                                                        xlink:href="{{ asset('img/icons/cost.svg#svg-cost') }}"></use></svg></span>
                                            <div class="card__price-info"><h4 class="card__price-title">Стоимость</h4>
    ...
    @foreach($users as $user)
        <div class="graph-modal__container graph-modal__container--contacts" role="dialog" aria-modal="true"
            ...
            <button class="btn js-modal-close graph-modal__close" aria-label="Закрыть модальное окно"><span
                    class="icon"><svg><use xlink:href="img/icons/x.svg#svg-x"></use></svg></span></button>
