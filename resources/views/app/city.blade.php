                ...
                <div class="container catalog__container">
                    <ul class="list-reset menu__job menu__job--catalog">
                        ...
                        @php
                            ...
                            $sortedCategories = $categoriesUpTo13->concat($categoriesAbove13);
                        @endphp
                        @foreach ($sortedCategories as $category)
                            <li>
                                <a href="{{ route('city', ['city' => $corrent_city->alias]) }}?category={{ $category->alias }}"
                    ...
                    <div class="catalog__content">
                        @if ($users->count() != 0)
                            @foreach ($users as $user)
                                @if ($user->role == 'executor' && $user->photos)
                                    <x-user-card :user="$user"></x-user-card>
                                @endif
                            @endforeach
                            <div class="pagination-links" style="max-width: 100%">
